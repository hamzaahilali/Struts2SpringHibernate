...
public class MobileFacetory {
	public Mobile getModelMobile(String str) {
		...
		if (str.equalsIgnoreCase("Phone 1")) {
			...
			Mobile phone1 = new Mobile("IOS9", 2, 128, screen, camera, false);
		...
		if (str.equalsIgnoreCase("Phone 2")) {
			...
			Mobile phone2 = new Mobile("Android 5.0", 2, 64, screen, camera, false);
		...
		if (str.equalsIgnoreCase("Phone 3")) {
			...
			Mobile phone3 = new Mobile("Window Phone 7", 1, 16, screen, camera, true);
		...
		if (str.equalsIgnoreCase("Phone 4")) {
			...
			Mobile phone4 = new Mobile("IOS8", 1, 32, screen, camera, true);
		...
		if (str.equalsIgnoreCase("Phone 5")) {
			...
			Mobile phone5 = new Mobile("Android 4.4", 1, 16, screen, camera, true);
		...
		if (str.equalsIgnoreCase("Phone 6")) {
			...
			Camera camera = new Camera(1, 2);
			Mobile phone6 = new Mobile("Android 4.0", 1, 16, screen, camera, true);
	...
	public MobileCase getMobileCase(String str) {
		...
		if (str.equalsIgnoreCase("Mobile Case 2")) {
			MobileCase mobileCase = new MobileCase("Mobile Case 2", 5, "Black", "MobileCase2",
					"Protect your Phone 24h");
			return mobileCase;
		}
	...
	public PowerBank getPoweBank(String str) {
		...
		if (str.equalsIgnoreCase("Power Bank 1")) {
			PowerBank powerBank = new PowerBank("Power Bank 1", 10, "White", "PowerBank1", "", 6600);
			return powerBank;
		}
		if (str.equalsIgnoreCase("Power Bank 2")) {
			PowerBank powerBank = new PowerBank("Power Bank 2", 12, "White", "PowerBank2", "", 5000);
			return powerBank;
		}
		if (str.equalsIgnoreCase("Power Bank 3")) {
			PowerBank powerBank = new PowerBank("Power Bank 3", 15, "White", "PowerBank3", "", 10000);
			return powerBank;
		}
		if (str.equalsIgnoreCase("Power Bank 4")) {
			PowerBank powerBank = new PowerBank("Power Bank 4", 8, "White", "PowerBank4", "", 10000);
			return powerBank;
		}
		if (str.equalsIgnoreCase("Power Bank 5")) {
			PowerBank powerBank = new PowerBank("Power Bank 5", 26, "White", "PowerBank5", "", 6000);
			return powerBank;
		}

		if (str.equalsIgnoreCase("Power Bank 6")) {
			PowerBank powerBank = new PowerBank("Power Bank 6", 30, "White", "PowerBank6", "", 8000);
			return powerBank;
		}
		return null;
	}
