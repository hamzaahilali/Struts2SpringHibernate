...
<body>
	...
	<s:push value="mobile">
		<ul>
<img src="<s:url value="/Image/Mobile/%{pic}_Large.jpg"/>" width="400" height="400"/>
			...
			<li>Rear Camera : <s:property value="Camera.rearCamera" /> MB</li>
			<li>Internal Storage : <s:property value="internalStorage" /> GB </li>
